...
# 进行一些处理
cp -rf openwrt/include/package-pack.mk /tmp/package-pack.mk.bak
cp -rf openwrt/include/package.mk /tmp/package.mk.bak
cp -rf openwrt/scripts/metadata.pm /tmp/metadata.pm.bak
