...
# svn export https://github.com/immortalwrt/luci/trunk/applications/luci-app-smartdns feeds/luci/applications/luci-app-smartdns
...
#依赖
rm -rf ./target/linux/rockchip/patches-5.4/601-net-phy-Add-driver-for-Motorcomm-YT8531-PHYs.patch
