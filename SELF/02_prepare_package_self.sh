...
echo -e " Paniy Build on "$(date +%Y.%m.%d)"\n -----------------------------------------------------\n" >> package/base-files/files/etc/banner
#补全部分依赖（实际上并不会用到
#svn co https://github.com/openwrt/openwrt/branches/master/package/libs/libjson-c package/libs/libjson-c
#ariang
...
#svn co https://github.com/coolsnowwolf/lede/trunk/package/lean/luci-app-mwan3helper package/new/luci-app-mwan3helper
...
#svn co https://github.com/coolsnowwolf/lede/trunk/package/lean/luci-app-syncdial package/new/luci-app-syncdial
#filetransfer
...
#svn co https://github.com/openwrt/packages/trunk/libs/readline package/libs/readline
